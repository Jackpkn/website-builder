        ...
        <div className="bg-gray-800/95 backdrop-blur-sm rounded-lg shadow-2xl border border-gray-700 overflow-hidden">
          ...
          <div className="p-4 border-b border-gray-700">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-lg font-bold text-white">AI Generating...</h2>
            </div>
            ...
            <p className="text-gray-300 text-sm">
              {currentFile
                ? fileSteps.find((step) => step.name === currentFile)?.title
                : "Preparing..."}
            </p>
          </div>
          ...
          <div className="p-3 border-t border-gray-700">
            <div className="flex justify-center space-x-2">
              {fileSteps.map((step, index) => {
                ...
                const isCompleted =
                  fileSteps.findIndex((s) => s.name === currentFile) > index;
                ...
                return (
                  <motion.div
                    ...
                    className={`flex items-center space-x-1.5 px-2 py-1 rounded-full transition-all duration-300 text-xs ${
                      isActive
