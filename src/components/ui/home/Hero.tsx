  ...
  return (
    <div className="min-h-screen text-white bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Main central teal glow */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial from-teal-500 via-teal-600 to-transparent rounded-full blur-3xl"></div>

        {/* Secondary glows for depth */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-radial from-teal-400 to-transparent rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-radial from-cyan-500 to-transparent rounded-full blur-3xl animate-pulse delay-1000"></div>

        {/* Subtle side gradients for black fade */}
